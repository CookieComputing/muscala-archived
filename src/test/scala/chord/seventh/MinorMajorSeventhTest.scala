...
/**
  * Unit tests for the minor major seventh class
  */
class MinorMajorSeventhTest extends ASeventhTest {
  val chordGenerator: Gen[SeventhChord] = PropertyTesting.chordGen(MinorMajorSeventh(_).get)
  val chordNotes: TableFor2[String, List[String]] = Table(
    ...
    ("Ab", List("Ab", "Cb", "Eb", "G")),
    ("Bb", List("Bb", "Db", "F", "A")),
    ("Cb", List("Cb", "Ebb", "Gb", "Bb")),
    ("Db", List("Db", "Fb", "Ab", "C")),
    ("Eb", List("Eb", "Gb", "Bb", "D")),
    ("Fb", List("Fb", "Abb", "Cb", "Eb")),
    ("Gb", List("Gb", "Bbb", "Db", "F")),
    ("A#", List("A#", "C#", "E#", "G##")),
    ("B#", List("B#", "D#", "F##", "A##")),
    ("C#", List("C#", "E", "G#", "B#")),
  ...
  val expectedChordName: String => String = tonic => tonic + Chord.minor + Chord.major + Chord.seventh
  val chordApplyFunction: String => Option[SeventhChord] = tonic => MinorMajorSeventh(tonic)
